...
LDLIBSOPTIONS=`pkg-config --libs libpng` -lm  -ljpeg `pkg-config --libs gl` `pkg-config --libs glew` `pkg-config --libs sdl2`  
...
${OBJECTDIR}/_ext/1690346760/AbstractFunction.o: ../../../modules/glbinding/source/glbinding/source/AbstractFunction.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DFG_NO_UNDEF -DFG_USING_GLEW -DFG_USING_GLM -DFG_USING_OPENGL -DFG_USING_OPENGL_GLEW -DFG_USING_SDL2 -DFG_USING_TINYXML -DTIXML_USE_STL -I../../../src -I../../../modules/glm -I../../../modules/tinyobj/upstream -I../../../modules/tinyxml/upstream -I../../../modules/stbfont/usascii -I../../../modules/stbfont `pkg-config --cflags libpng` `pkg-config --cflags gl` `pkg-config --cflags glew` `pkg-config --cflags sdl2` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1690346760/AbstractFunction.o ../../../modules/glbinding/source/glbinding/source/AbstractFunction.cpp
...
${OBJECTDIR}/_ext/1210739651/fgScriptManager.o: ../../../src/Scripting/fgScriptManager.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DFG_NO_UNDEF -DFG_USING_GLEW -DFG_USING_GLM -DFG_USING_OPENGL -DFG_USING_OPENGL_GLEW -DFG_USING_SDL2 -DFG_USING_TINYXML -DTIXML_USE_STL -I../../../src -I../../../modules/glm -I../../../modules/tinyobj/upstream -I../../../modules/tinyxml/upstream -I../../../modules/stbfont/usascii -I../../../modules/stbfont `pkg-config --cflags libpng` `pkg-config --cflags gl` `pkg-config --cflags glew` `pkg-config --cflags sdl2` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1210739651/fgScriptManager.o ../../../src/Scripting/fgScriptManager.cpp
