...
const long FlexiGameEditorFrame::idMenuAbout = wxNewId();
...
FlexiGameEditorFrame::FlexiGameEditorFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, id, _("FlexiGame::Editor 1.0"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_FRAME_STYLE, _T("id"));
    ...
    Connect(idMenuAbout,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&FlexiGameEditorFrame::OnAbout);
    //*)
}
