    ...
    namespace base {
        ...
        public:
            ...
            enum class Mode : unsigned int {
                NONE = 0, // No mode specified (invalid).
                READ = 1 << 0, // Open file for input operations. The file must exist.
                WRITE = 1 << 1, // Create an empty file for output operations.
                APPEND = 1 << 2, // Open file for output at the end of a file. The file is created if it does not exist.
                UPDATE = 1 << 3, // Additional update mode (both input/output).
                BINARY = 1 << 4, // Open file as a binary file.
        ...
        public:
             ...
             * @param filePath
             */
            virtual void setPath(std::string & filePath) {
                m_filePath = filePath;
            }
            /**
             ...
             * @return 
             */
            virtual fgBool flushFile(void) = 0;
