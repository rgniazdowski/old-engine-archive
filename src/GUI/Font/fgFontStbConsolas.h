...
#ifndef FG_INC_FONT_STB_CONSOLAS
    #define FG_INC_FONT_STB_CONSOLAS
    #define FG_INC_FONT_STB_CONSOLAS_BLOCK
...
namespace fg {
    ...
    #undef FG_INC_FONT_STB_CONSOLAS_BLOCK
#endif /* FG_INC_FONT_STB_CONSOLAS */
