...
public:
	...
	fgGuiWidget *getFather(void) const {
		return m_fatherPtr;
	}

	//
	fgGuiWidgetType getType(void) const {
		return m_type;
	}

	//
	fgGuiWidgetType getTypeTraits(void) const {
		return m_typeTraits;
	}
	...
	//
	const char *getTypeNameStr(void) const {
...
public:
	...
	void setVisible(fgBool toggle = FG_TRUE) {
		m_isVisible = toggle;
	}
	...
	void setActive(fgBool toggle = FG_TRUE) {
		m_isActive = toggle;
		if(m_isActive) {
	...
	void setIgnoreState(fgBool toggle = FG_TRUE) {
		m_ignoreState = toggle;
	}

	//
	fgBool doesIgnoreState(void) const {
		return m_ignoreState;
	}

	//
	fgBool isIgnoreState(void) const {
		return m_ignoreState;
	}

	//
	fgGuiWidgetState getState(void) const {
		return m_state;
	}
	...
	//
	fgVector3f& getRelativePos(void) {
		return m_relPos;
	}

	//
	void setSize(const fgVector3f& size) {
		m_bbox.size = size;
	}

	// Returns the reference to the vector holding widget size 
	fgVector3f& getSize(void) {
		return m_bbox.size;
	}
	...
	//
	const char *getLinkStr(void) const {
		return m_link.c_str();
	}
	...
	//
	const char *getScriptStr(void) const {
	...
	//
	const char *getActionStr(void) const {
	...
	//
	const char *getConfigStr(void) const {
	...
	//
	const char *getStyleNameStr(void) const {
	...
	fgGuiStyleContent* getStyleContents(void) {
		return m_styles;
	}

	//
	fgGuiStyleContent& getStyleContent(void) {
	...
	//
	fgGuiStyleContent& getStyleContent(fgGuiWidgetState state) {
	...
	//
	void setOnFocusCallback(fgGuiCallback *callback) {
		m_onFocus = callback;
	}

	//
	void setOnFocusLostCallback(fgGuiCallback *callback) {
		m_onFocusLost = callback;
	}

	//
	void setOnClickCallback(fgGuiCallback *callback) {
		m_onClick = callback;
	}

	//
	void setOnActivateCallback(fgGuiCallback *callback) {
		m_onActivate = callback;
	}

	//
	void setOnDeactivateCallback(fgGuiCallback *callback) {
		m_onDeactivate = callback;
	}

	//
	void setOnKeyCallback(fgGuiCallback *callback) {
		m_onKey = callback;
	}

	//
	void setOnMouseCallback(fgGuiCallback *callback) {
		m_onMouse = callback;
	}

	//
	void setOnChangeStateCallback(fgGuiCallback *callback) {
		m_onChangeState = callback;
	}

	//
	fgGuiCallback *getOnFocusCallback(void) const {
		return m_onFocus;
	}

	//
	fgGuiCallback *getOnFocusLostCallback(void) const {
		return m_onFocusLost;
	}

	//
	fgGuiCallback *getOnClickCallback(void) const {
		return m_onClick;
	}

	//
	fgGuiCallback *getOnActivateCallback(void) const {
		return m_onActivate;
	}

	//
	fgGuiCallback *getOnDeactivateCallback(void) const {
		return m_onDeactivate;
	}

	//
	fgGuiCallback *getOnKeyCallback(void) const {
		return m_onKey;
	}

	//
	fgGuiCallback *getOnMouseCallback(void) const {
		return m_onMouse;
	}

	//
	fgGuiCallback *getOnChangeStateCallback(void) const {
	...
	fgGuiWidgetHandle getHandle(void) const {
		return m_handle;
	}

	// Set the widget handle ID 
	void setHandle(fgGuiWidgetHandle handle) {
		m_handle = handle;
	}

	//
	fgGuiWidgetHandle& getRefHandle(void) {
		return m_handle;
	}
};
