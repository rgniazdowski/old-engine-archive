...
namespace LPCD {
    ...
    template<> struct Type<fgVector2i> {
        ...
        #endif
            obj.SetMetatable(state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::VECTOR2I_MT_ID)]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::VECTOR2I_MT_ID)];
        }
    ...
    template<> struct Type<fgVector2f> {
        ...
        #endif
            obj.SetMetatable(state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::VECTOR2F_MT_ID)]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::VECTOR2F_MT_ID)];
        }
    ...
    template<> struct Type<fgVector3i> {
        ...
        #endif
            obj.SetMetatable(state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::VECTOR3I_MT_ID)]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::VECTOR3I_MT_ID)];
        }
    ...
    template<> struct Type<fgVector3f> {
        ...
        #endif
            obj.SetMetatable(state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::VECTOR3F_MT_ID)]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::VECTOR3F_MT_ID)];
        }
    ...
    template<> struct Type<fgVector4i> {
        ...
        #endif
            obj.SetMetatable(state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::VECTOR4I_MT_ID)]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::VECTOR4I_MT_ID)];
        }
    ...
    template<> struct Type<fgVector4f> {
        ...
        #endif
            obj.SetMetatable(state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::VECTOR4F_MT_ID)]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::VECTOR4F_MT_ID)];
        }
...
namespace LPCD {
    ...
    template<> struct Type<fgGuiWidget *> {
        static inline void Push(lua_State* L, const fgGuiWidget * value) {
            ...
            fgScriptMetatables::METAID metaID = fgScriptMetatables::getMetatableIDFromWidgetType(value->getType());
    ...
    template<> struct Type<fgGuiStyleContent *> {
        static inline void Push(lua_State* L, const fgGuiStyleContent * value) {
            ...
            // (BoxPointer) simply push already existing pointer
            // Maybe create something like universal Push?
            fgScriptMetatables::METAID metaID = fgScriptMetatables::GUI_STYLE_CONTENT_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
        #if defined(FG_DEBUG)
        ...
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            bool result = (obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_CONTENT_MT_ID)]);
            // This is fubar
            //result = (bool) obj.IsUserdata();
            return result;
        }
    ...
    template<> struct Type<fgGuiSize> {
        ...
        #endif
            const char *metatableName = fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_SIZE_MT_ID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_SIZE_MT_ID)];
        }
    ...
    template<> struct Type<fgGuiBackground> {
        ...
        #endif
            const char *metatableName = fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_BACKGROUND_MT_ID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_BACKGROUND_MT_ID)];
        }
    ...
    template<> struct Type<fgGuiForeground> {
        ...
        #endif
            const char *metatableName = fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_FOREGROUND_MT_ID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_FOREGROUND_MT_ID)];
        }
    ...
    template<> struct Type<fgGuiMargin> {
        ...
        #endif
            const char *metatableName = fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_MARGIN_MT_ID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_MARGIN_MT_ID)];
        }
    ...
    template<> struct Type<fgGuiBorderInfo> {
        ...
        #endif
            const char *metatableName = fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_BORDER_INFO_MT_ID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_BORDER_INFO_MT_ID)];
        }
    ...
    template<> struct Type<fgGuiBorder> {
        ...
        #endif
            const char *metatableName = fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_BORDER_MT_ID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_BORDER_MT_ID)];
        }
    ...
    template<> struct Type<fgGuiPosition> {
        ...
        #endif
            const char *metatableName = fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_POSITION_MT_ID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::GUI_STYLE_POSITION_MT_ID)];
        }
    ...
    template<> struct Type<fgEvent *> {
        static inline void Push(lua_State* L, const fgEvent * value) {
            ...
            // (BoxPointer) simply push already existing pointer
            // Maybe create something like universal Push?
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_MAIN_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
        #if defined(FG_DEBUG)
        ...
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            bool result = (obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_MAIN_MT_ID)]);
            // This is fubar
            //result = (bool) obj.IsUserdata();
            return result;
        }
    ...
    template<> struct Type<fgTouchEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_TOUCH_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_TOUCH_MT_ID)];
        }
    ...
    template<> struct Type<fgMouseEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_MOUSE_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_MOUSE_MT_ID)];
        }
    ...
    template<> struct Type<fgSwipeEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_SWIPE_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_SWIPE_MT_ID)];
        }
    ...
    template<> struct Type<fgSwipePinchEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_SWIPE_PINCH_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_SWIPE_PINCH_MT_ID)];
        }
    ...
    template<> struct Type<fgSwipeRotateEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_SWIPE_ROTATE_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_SWIPE_ROTATE_MT_ID)];
        }
    ...
    template<> struct Type<fgKeyEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_KEY_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_KEY_MT_ID)];
        }
    ...
    template<> struct Type<fgResourceEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_RESOURCE_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_RESOURCE_MT_ID)];
        }
    ...
    template<> struct Type<fgVertexStreamEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_VERTEX_STREAM_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_VERTEX_STREAM_MT_ID)];
        }
    ...
    template<> struct Type<fgCameraEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_CAMERA_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_CAMERA_MT_ID)];
        }
    ...
    template<> struct Type<fgSoundEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_SOUND_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_SOUND_MT_ID)];
        }
    ...
    template<> struct Type<fgMenuChangedEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_MENU_CHANGED_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_MENU_CHANGED_MT_ID)];
        }
    ...
    template<> struct Type<fgWidgetEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_WIDGET_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_WIDGET_MT_ID)];
        }
    ...
    template<> struct Type<fgSensorsEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_SENSORS_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_SENSORS_MT_ID)];
        }
    ...
    template<> struct Type<fgControllerDeviceEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_CONTROLLER_DEVICE_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_CONTROLLER_DEVICE_MT_ID)];
        }
    ...
    template<> struct Type<fgControllerButtonEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_CONTROLLER_BUTTON_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_CONTROLLER_BUTTON_MT_ID)];
        }
    ...
    template<> struct Type<fgControllerAxisEvent> {
        ...
        #endif
            fgScriptMetatables::METAID metaID = fgScriptMetatables::EVENT_CONTROLLER_AXIS_MT_ID;
            const char *metatableName = fgScriptMetatables::getMetatableName(metaID);
            obj.SetMetatable(state->GetRegistry()[metatableName]);
        }
        static inline bool Match(lua_State* L, int idx) {
            LuaPlus::LuaState* state = lua_State_to_LuaState(L);
            LuaPlus::LuaObject obj = state->Stack(idx);
            return obj.GetMetatable() == state->GetRegistry()[fgScriptMetatables::getMetatableName(fgScriptMetatables::EVENT_CONTROLLER_AXIS_MT_ID)];
        }
