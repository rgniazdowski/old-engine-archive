 ...
 * inter-related.
 */
#ifndef FG_INC_PARTICLE_CONTACT
    #define FG_INC_PARTICLE_CONTACT
...
namespace fg {
    namespace physics {
        ...
        public:
             ...
             */
            CParticleContactResolver(unsigned iterations);
             ...
             */
            void resolveContacts(CParticleContact *contactArray,
    ...
    #undef FG_INC_PARTICLE_CONTACT_BLOCK
#endif /* FG_INC_PARTICLE_CONTACT */
