 ...
 * assemblies.
 */
#ifndef FG_INC_PHYSICS_PARTICLE
    #define FG_INC_PHYSICS_PARTICLE
    #define FG_INC_PHYSICS_PARTICLE_BLOCK
...
namespace fg {
    ...
    #undef FG_INC_PHYSICS_PARTICLE_BLOCK
#endif /* FG_INC_PHYSICS_PARTICLE */
