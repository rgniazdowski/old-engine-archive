 ...
 */
#ifndef FG_INC_PHYSICS_BODY
    #define FG_INC_PHYSICS_BODY
    #define FG_INC_PHYSICS_BODY_BLOCK
...
namespace fg {
    namespace physics {
        ...
        public:
             ...
             */
            void getInertiaTensor(Matrix3f *inertiaTensor) const;
             ...
             */
            void getInertiaTensorWorld(Matrix3f *inertiaTensor) const;
             ...
             * from the rigid body.
             */
            void setInverseInertiaTensor(const Matrix3f &inverseInertiaTensor);
             ...
             * space.
             */
            void getInverseInertiaTensor(Matrix3f *inverseInertiaTensor) const;
             ...
             */
            void getInverseInertiaTensorWorld(Matrix3f *inverseInertiaTensor) const;
             ...
             * the position.
             */
            void getPosition(Vector3f *position) const;
             ...
             * orientation data.
             */
            void getOrientation(Quaternionf *orientation) const;
             ...
             */
            void getOrientation(Matrix3f *matrix) const;
             ...
             */
            void getTransform(Matrix4f *transform) const;
             ...
             * @param matrix A pointer to the matrix to fill.
             */
            void getTransform(real *matrix) const;
             ...
             * @param matrix A pointer to the matrix to fill.
             */
            void getGLTransform(float *matrix) const;
             ...
             */
            Vector3f getPointInLocalSpace(const Vector3f &point) const;
             ...
             */
            Vector3f getDirectionInLocalSpace(const Vector3f &direction) const;
             ...
             */
            Vector3f getDirectionInWorldSpace(const Vector3f &direction) const;
             ...
             */
            void getVelocity(Vector3f *velocity) const;
             ...
             */
            void addVelocity(const Vector3f &deltaVelocity);
             ...
             */
            void getRotation(Vector3f *rotation) const;
             ...
             */
            void addRotation(const Vector3f &deltaRotation);
            /**
             ...
             */
            void getLastFrameAcceleration(Vector3f *linearAcceleration) const;
             ...
             */
            void getAcceleration(Vector3f *acceleration) const;
    ...
    #undef FG_INC_PHYSICS_BODY_BLOCK
#endif /* FG_INC_PHYSICS_BODY */
