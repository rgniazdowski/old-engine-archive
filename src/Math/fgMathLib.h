...
struct fgVector2i {
    ...
    inline int operator ==(const fgVector2i &v) {
        return (x == v.x && y == v.y);
    }
    inline int operator !=(const fgVector2i &v) {
        return !(*this == v);
    }
    inline const fgVector2i operator *(int f)const {
        return fgVector2i(int(x * f), int(y * f));
    }
    inline const fgVector2i operator /(int f)const {
        return fgVector2i(int(x / f), int(y / f));
    }
    inline const fgVector2i operator +(const fgVector2i &v) const {
        return fgVector2i(x + v.x, y + v.y);
    }
    inline const fgVector2i operator -() const {
        return fgVector2i(-x, -y);
    }
    inline const fgVector2i operator -(const fgVector2i &v) const {
        return fgVector2i(x - v.x, y - v.y);
    }
    inline fgVector2i &operator *=(int f) {
        return *this = *this * f;
    }
    inline fgVector2i &operator /=(int f) {
        return *this = *this / f;
    }
    inline fgVector2i &operator +=(const fgVector2i &v) {
        return *this = *this +v;
    }
    inline fgVector2i &operator -=(const fgVector2i &v) {
        return *this = *this -v;
    }
    inline int operator *(const fgVector2i &v) const {
        return x * v.x + y * v.y;
    }
    inline operator int*() {
        return (int*)&x;
...
struct fgVector2f {
    ...
    inline int operator ==(const fgVector2f &v) {
        return (fabs(x - v.x) < FG_EPSILON && fabs(y - v.y) < FG_EPSILON);
    }
    inline int operator !=(const fgVector2f &v) {
        return !(*this == v);
    }
    inline const fgVector2f operator *(float f)const {
        return fgVector2f(x * f, y * f);
    }
    inline const fgVector2f operator /(float f)const {
        return fgVector2f(x / f, y / f);
    }
    inline const fgVector2f operator +(const fgVector2f &v) const {
        return fgVector2f(x + v.x, y + v.y);
    }
    inline const fgVector2f operator -() const {
        return fgVector2f(-x, -y);
    }
    inline const fgVector2f operator -(const fgVector2f &v) const {
        return fgVector2f(x - v.x, y - v.y);
    }
    inline fgVector2f &operator *=(float f) {
        return *this = *this * f;
    }
    inline fgVector2f &operator /=(float f) {
        return *this = *this / f;
    }
    inline fgVector2f &operator +=(const fgVector2f &v) {
        return *this = *this +v;
    }
    inline fgVector2f &operator -=(const fgVector2f &v) {
        return *this = *this -v;
    }
    inline float operator *(const fgVector2f &v) const {
        return x * v.x + y * v.y;
    }
...
struct fgVector3f {
    ...
    inline int operator ==(const fgVector3f &v) {
        return (fabs(x - v.x) < FG_EPSILON && fabs(y - v.y) < FG_EPSILON && fabs(z - v.z) < FG_EPSILON);
    }
    inline int operator !=(const fgVector3f &v) {
        return !(*this == v);
    }
    inline const fgVector3f operator *(float f)const {
        return fgVector3f(x * f, y * f, z * f);
    }
    inline const fgVector3f operator /(float f)const {
        return fgVector3f(x / f, y / f, z / f);
    }
    inline const fgVector3f operator +(const fgVector3f &v) const {
        return fgVector3f(x + v.x, y + v.y, z + v.z);
    }
    inline const fgVector3f operator -() const {
        return fgVector3f(-x, -y, -z);
    }
    inline const fgVector3f operator -(const fgVector3f &v) const {
        return fgVector3f(x - v.x, y - v.y, z - v.z);
    }
    inline fgVector3f &operator *=(float f) {
        return *this = *this * f;
    }
    inline fgVector3f &operator /=(float f) {
        return *this = *this / f;
    }
    inline fgVector3f &operator +=(const fgVector3f &v) {
        return *this = *this +v;
    }
    inline fgVector3f &operator -=(const fgVector3f &v) {
        return *this = *this -v;
    }
    inline float operator *(const fgVector3f &v) const {
...
struct fgVector4f {
    ...
    inline int operator ==(const fgVector4f &v) {
        return (fabs(x - v.x) < FG_EPSILON && fabs(y - v.y) < FG_EPSILON && fabs(z - v.z) < FG_EPSILON && fabs(w - v.w) < FG_EPSILON);
    }
    inline int operator !=(const fgVector4f &v) {
        return !(*this == v);
    }
    inline const fgVector4f operator *(float f)const {
        return fgVector4f(x * f, y * f, z * f, w * f);
    }
    inline const fgVector4f operator /(float f)const {
        return fgVector4f(x / f, y / f, z / f, w / f);
    }
    inline const fgVector4f operator +(const fgVector4f &v) const {
        return fgVector4f(x + v.x, y + v.y, z + v.z, w + v.w);
    }
    inline const fgVector4f operator -() const {
        return fgVector4f(-x, -y, -z, -w);
    }
    inline const fgVector4f operator -(const fgVector4f &v) const {
        return fgVector4f(x - v.x, y - v.y, z - v.z, z - v.w);
    }
    inline fgVector4f &operator *=(float f) {
        return *this = *this * f;
    }
    inline fgVector4f &operator /=(float f) {
        return *this = *this / f;
    }
    inline fgVector4f &operator +=(const fgVector4f &v) {
        return *this = *this +v;
    }
    inline fgVector4f &operator -=(const fgVector4f &v) {
        return *this = *this -v;
...
struct fgMatrix3f {
    ...
    fgMatrix3f &operator *=(float f) {
        return *this = *this * f;
    }
    fgMatrix3f &operator *=(const fgMatrix3f &m) {
        return *this = *this * m;
    }
    fgMatrix3f &operator +=(const fgMatrix3f &m) {
        return *this = *this +m;
...
struct fgMatrix4f {
    ...
    fgMatrix4f &operator *=(float f) {
        return *this = *this * f;
    }
    fgMatrix4f &operator *=(const fgMatrix4f &m) {
        return *this = *this * m;
    }
    fgMatrix4f &operator +=(const fgMatrix4f &m) {
        return *this = *this +m;
