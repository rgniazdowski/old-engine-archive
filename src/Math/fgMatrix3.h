...
#ifndef FG_INC_MATH_MATRIX_3
    #define FG_INC_MATH_MATRIX_3
    #define FG_INC_MATH_MATRIX_3_BLOCK
...
namespace fg {
        ...
        #if !defined(FG_MATH_GLM_MATRIX_3_MASK)
            #define FG_MATH_GLM_MATRIX_3_MASK

            #if !defined(FG_MATH_GLM_MATRIX_3_TEMPLATE_MASK)
                #define FG_MATH_GLM_MATRIX_3_TEMPLATE_MASK
    ...
    using Mat3T = glm::detail::tmat3x3<T, glm::defaultp>;
                ...
                #endif /* */
            #endif /* !defined(FG_MATH_MATRIX_3_TEMPLATE_MASK) */
    ...
    typedef Matrix3d Mat3d;
        ...
        #endif /* !defined(FG_MATH_GLM_MATRIX_3_MASK) */
...
// Possible use-case? Level of abstraction over DX-* functions.
    ...
    #undef FG_INC_MATH_MATRIX_3_BLOCK
#endif /* FG_INC_MATH_MATRIX_3 */
