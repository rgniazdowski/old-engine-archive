...
public:
    ...
    // Loads a JPEG file and returns unsigned char array with raw data
    static unsigned char *loadJPEG(fg::util::base::CFile *fileStream, int &width, int &height);
    ...
    // Loads a PNG file and returns unsigned char array with raw data
    static unsigned char *loadPNG(fg::util::base::CFile *fileStream, int &width, int &height);
    ...
    // Loads a TGA file and returns unsigned char array with raw data
    static unsigned char *loadTGA(fg::util::base::CFile *fileStream, int &width, int &height);
