...
#ifndef _FG_GFX_ERROR_CODES_H_
#define _FG_GFX_ERROR_CODES_H_
...
#define FG_ERRNO_GFX_LAST_CODE				FG_ERRNO_GFX_BASE_CODE(0)

#define FG_ERRNO_GFX_OK_TEXT "No error"
