...
struct fgSoundWAVHeader {
    ...
    static size_t size(void) {
        return sizeof (fgSoundWAVHeader);
    }
};
...
struct fgSoundWAVChunkHeader {
     ...
     * 
     */
    fgSoundWAVChunkHeader() : subChunkDataSize(0) {
     ...
     */
    static size_t size(void) {
        return sizeof (fgSoundWAVChunkHeader);
    }
};
